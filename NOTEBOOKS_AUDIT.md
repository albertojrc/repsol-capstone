...
**Updated:** 2026-06-09 (notebooks reorganised — new sequential numbering)  
**Total notebooks:** 9 (07_tableau_prep.ipynb deleted)  
**Pipeline order:** 01 → 02 → 03 → 04 → 05 → 06 → 07 → 08 → 09
...
|---|----------|---------------|-----------------|---------------------|------------------------|
| 01 | `01_eda.ipynb` | consumo_biodiesel_ccaa.csv | figures 01–04 | No (EDA only) | Yes |
...
| 04 | `04_master_dataset.ipynb` | All inputs | **master_dataset.csv** | Builds it | N/A |
| 05 | `05_feature_engineering.ipynb` | master_dataset.csv | features_*.csv | **Yes** | Yes |
| 06 | `06_price_features.ipynb` | precios_combustibles_*.csv, master_dataset.csv | features_precios_combustibles.csv | **Yes** | Yes |
| 07 | `07_modeling.ipynb` | features_*.csv, master_dataset.csv | metricas_modelos.csv, predictions, forecast | **Yes** | Yes |
| 08 | `08_modeling_with_prices.ipynb` | features_*.csv, master_dataset.csv, outputs | metricas_*_con_precios.csv, forecast | **Yes** | Yes |
| 09 | `09_evaluation.ipynb` | outputs + features, master_dataset.csv | figures 07–11 | **Yes** | Yes |
...
### `04_master_dataset.ipynb` — Master Dataset Builder ⭐
...
- **Formerly:** `10_master_dataset.ipynb`

---

### `05_feature_engineering.ipynb` — Feature Engineering ✅ UPDATED
...
- **TARGET_LABEL mapping:**
  ...
  ```
- **Status:** Complete
- **Formerly:** `04_feature_engineering.ipynb`

---

### `06_price_features.ipynb` — Fuel Price Feature Engineering ✅ UPDATED
...
- **Status:** Complete
- **Formerly:** `08_price_features.ipynb`

---

### `07_modeling.ipynb` — Modelling (SARIMA + ML) ✅ UPDATED
...
- **Status:** Complete
- **Formerly:** `05_modeling.ipynb`

---

### `08_modeling_with_prices.ipynb` — Price-Augmented Modelling ✅ UPDATED
...
- **Status:** Complete
- **Formerly:** `09_modeling_with_prices.ipynb`

---

### `09_evaluation.ipynb` — Model Evaluation ✅ UPDATED
...
- **Status:** Complete
- **Formerly:** `06_evaluation.ipynb`

---

### ~~`07_tableau_prep.ipynb`~~ — DELETED
- Tableau export notebook removed from the pipeline.
- Tableau outputs (`tableau_dashboard.csv`, `tableau_metricas.csv`, `tableau_forecast_pivot.csv`) remain in `data/outputs/` from previous runs.
...
|-----------------|-----------------|----------------|
| `df_macro` load from macro_indicadores_ine.csv | Notebooks 07, 08, 09 | Replaced with master_dataset in all three |
| `TARGET_LABEL` dict | Notebooks 05, 06, 08 | Defined locally in each (consistent) |
| `PROVINCE_CCAA` mapping | Notebook 04 + script 02 | Defined in both (intentional) |
| Feature list `ML_FEATS` / `ML_BASE` | Notebooks 07, 08, 09 | Defined locally in each (consistent) |
